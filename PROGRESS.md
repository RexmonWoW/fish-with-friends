...
- **Per-Run Shop v1 done (2026-09-02)**: counter in the lobby, host-authoritative purchases (`ShopCounter`), item list in `ShopCatalog`. Only the counter + interaction were built, not the rest of the lobby (mirror/trophy case) -- still not started, cosmetics don't exist yet.
