...
## Next Up
- **2-machine test in progress (passes 31-33) — movement CONFIRMED working.** Everything else still needs re-verification after three full rounds of real bugs surfacing as soon as things became visible/testable, most recently: capsize toss still not landing every player in water, cast-cancel existed but wasn't discoverable, Big Fish Event QTE label was blank. Treat nothing here as done until a clean pass with no new reports.
